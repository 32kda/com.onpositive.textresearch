...
public class NeuralConstants {
	...
	public static final Class<? extends Grammem>[] USED_PROPS = (Class<? extends Grammem>[]) new Class<?>[] {
			PartOfSpeech.class, Case.class, Gender.class, SemanGramem.class, SingularPlural.class, VerbKind.class,
			TransKind.class,FeaturesGramem.class };
	// public static final Class<? extends Grammem>[] USED_PROPS = (Class<?
	// extends Grammem>[]) new Class<?>[]
	// {PartOfSpeech.class };
