...
`     */
    public IntOpenHashSetSerializable()
    {
     ...
     * load factor of {@value #DEFAULT_LOAD_FACTOR}.
     */
    public IntOpenHashSetSerializable(int initialCapacity)
    {
     ...
     */
    public IntOpenHashSetSerializable(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntOpenHashSetSerializable(IntContainer container)
    {
     ...
     */
    @Override
    public IntOpenHashSetSerializable clone()
    {
        try
        {
            /*  */
            IntOpenHashSetSerializable cloned = (IntOpenHashSetSerializable) super.clone();
     ...
     */
    public static  IntOpenHashSetSerializable from(int... elements)
    {
        final IntOpenHashSetSerializable set = new IntOpenHashSetSerializable(
     ...
     */
    public static  IntOpenHashSetSerializable from(IntContainer container)
    {
        return new IntOpenHashSetSerializable(container);
    }
     ...
     */
    public static  IntOpenHashSetSerializable newInstance()
    {
     ...
     */
    public static  IntOpenHashSetSerializable newInstanceWithoutPerturbations()
    {
        return new IntOpenHashSetSerializable() {
            @Override
     ...
     * instead of using a constructor).
     */
    public static  IntOpenHashSetSerializable newInstanceWithCapacity(int initialCapacity, float loadFactor)
    {
        return new IntOpenHashSetSerializable(initialCapacity, loadFactor);
    }
     ...
     */
    public static  IntOpenHashSetSerializable newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * capacity to hold <code>expectedSize</code> elements without having to resize.
     */
    public static  IntOpenHashSetSerializable newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
