...
/**
 * A hash map of <code>int</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntIntOpenHashMap.java") 
public class IntIntOpenHashMapSerialable
    implements IntIntMap, Cloneable,Serializable
{
    /**
	 * 
	 */
     ...
     */
    public IntIntOpenHashMapSerialable()
    {
     ...
     */
    public IntIntOpenHashMapSerialable(int initialCapacity)
    {
     ...
     */
    public IntIntOpenHashMapSerialable(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntIntOpenHashMapSerialable(IntIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        IntIntAssociativeContainer container)
    {
        final int count = this.assigned;
        for (IntIntCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends IntIntCursor> iterable)
    {
        final int count = this.assigned;
    ...
    {
        private final IntIntOpenHashMapSerialable owner = 
            IntIntOpenHashMapSerialable.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntIntOpenHashMapSerialable.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntIntOpenHashMapSerialable.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntIntOpenHashMapSerialable.this.allocated;                                                              
            final int [] values = IntIntOpenHashMapSerialable.this.values;                                                                      
     ...
     */
    @Override
    public IntIntOpenHashMapSerialable clone()
    {
        try
        {
            /*  */
            IntIntOpenHashMapSerialable cloned = 
                (IntIntOpenHashMapSerialable) super.clone();
     ...
     */
    public static  IntIntOpenHashMapSerialable from(int [] keys, int [] values)
    {
     ...
     */
    public static  IntIntOpenHashMapSerialable from(IntIntAssociativeContainer container)
    {
        return new IntIntOpenHashMapSerialable(container);
    }
     ...
     * shortcut). 
     */
    public static  IntIntOpenHashMapSerialable newInstance()
    {
        return new IntIntOpenHashMapSerialable();
    }
     ...
     */
    public static  IntIntOpenHashMapSerialable newInstanceWithoutPerturbations()
    {
        return new IntIntOpenHashMapSerialable() {
            @Override
     ...
     * shortcut). 
     */
    public static  IntIntOpenHashMapSerialable newInstance(int initialCapacity, float loadFactor)
    {
        return new IntIntOpenHashMapSerialable(initialCapacity, loadFactor);
    }
     ...
     */
    public static  IntIntOpenHashMapSerialable newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  IntIntOpenHashMapSerialable newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
