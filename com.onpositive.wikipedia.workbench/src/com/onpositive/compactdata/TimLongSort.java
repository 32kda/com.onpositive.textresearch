...
class TimLongSort {
     ...
     */
    private long[] tmp; // Actual runtime type will be Object[], regardless of long
     ...
     */
    private TimLongSort(long[] a, LongComparator c) {
        this.a = a;
        this.c = c;
        ...
        long[] newArray = (long[]) new long[len < 2 * INITIAL_TMP_STORAGE_LENGTH ?
    ...
    public static void sort(long[] a, int lo, int hi, LongComparator c) {
         ...
         */
        TimLongSort  ts = new TimLongSort(a, c);
    ...
    private void mergeAt(int i) {
         ...
         * run now, also slide over the last run (which isn'long involved
     ...
     * appropriate exception if they aren'long.
     *
