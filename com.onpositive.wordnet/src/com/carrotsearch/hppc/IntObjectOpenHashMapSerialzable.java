...
/**
 * A hash map of <code>int</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntObjectOpenHashMap.java") 
public class IntObjectOpenHashMapSerialzable<VType>
    implements IntObjectMap<VType>, Cloneable,Serializable
{
    /**
	 * 
	 */
     ...
     */
    public IntObjectOpenHashMapSerialzable()
    {
     ...
     */
    public IntObjectOpenHashMapSerialzable(int initialCapacity)
    {
     ...
     */
    public IntObjectOpenHashMapSerialzable(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntObjectOpenHashMapSerialzable(IntObjectAssociativeContainer<VType> container)
    {
    ...
    @Override
    public int putAll(
        IntObjectAssociativeContainer<? extends VType> container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends IntObjectCursor<? extends VType>> iterable)
    {
        final int count = this.assigned;
    ...
    private void allocateBuffers(int capacity)
    {
        ...
        VType [] values = Internals.<VType[]>newArray(capacity);
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof IntObjectMap)
            {
                ...
                /*  */
                IntObjectMap<VType> other = (IntObjectMap<VType>) obj;
    ...
    public final class KeysContainer 
        extends AbstractIntCollection implements IntLookupContainer
    {
        private final IntObjectOpenHashMapSerialzable<VType> owner = 
            IntObjectOpenHashMapSerialzable.this;
        ...
        {
            final int [] localKeys = owner.keys;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntObjectOpenHashMapSerialzable.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntObjectOpenHashMapSerialzable.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntObjectOpenHashMapSerialzable.this.allocated;                                                              
            final VType [] values = IntObjectOpenHashMapSerialzable.this.values;                                                                      
                                                                                                                                              
            for (int slot = 0; slot < allocated.length; slot++)                                                                               
            {                                                                                                                                 
                if (allocated[slot] && ((value) == null ? (values[slot]) == null : (value).equals((values[slot]))))                                    
                {                                                                                                                             
                    return true;                                                                                                              
                }                                                                                                                             
            }
     ...
     */
    @Override
    public IntObjectOpenHashMapSerialzable<VType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            IntObjectOpenHashMapSerialzable<VType> cloned = 
                (IntObjectOpenHashMapSerialzable<VType>) super.clone();
     ...
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> from(int [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        IntObjectOpenHashMapSerialzable<VType> map = new IntObjectOpenHashMapSerialzable<VType>();
     ...
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> from(IntObjectAssociativeContainer<VType> container)
    {
        return new IntObjectOpenHashMapSerialzable<VType>(container);
    }
     ...
     * shortcut). 
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> newInstance()
    {
        return new IntObjectOpenHashMapSerialzable<VType>();
    }
     ...
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> newInstanceWithoutPerturbations()
    {
        return new IntObjectOpenHashMapSerialzable<VType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new IntObjectOpenHashMapSerialzable<VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> IntObjectOpenHashMapSerialzable<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
